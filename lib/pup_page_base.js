...
class PupPageBase {
  /**
   * Represents PupPageBase - Common functionality found in a page
   * @param {Pup} pup
   * @param {object} opts - options pageIndex
   */
  ...
  /**
   * Returns the puppeteer page
   * @async
   * @method
   * @returns {Page} Puppeteer Page
   * See {@link https://pptr.dev/#?product=Puppeteer&version=v8.0.0&show=api-class-page}
   */
  async page() {
